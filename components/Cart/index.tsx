    ...
    >
      ...
      <hr className="my-3" />
      {
        hasProducts ? (
          ...
          <h3 className="text-center font-bold text-blue-600">There are no items i the cart</h3>
        )
      }
      <a className={`${!hasProducts ? "hidden" : ""} flex items-center justify-center mt-4 px-3 py-2 bg-blue-600 text-white text-sm uppercase font-medium rounded hover:bg-blue-500 focus:outline-none focus:bg-blue-500"`}>
        <span > Checkout</span>
        <svg
